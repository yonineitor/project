...
<html lang="en">
    ...
    <body id="page-top" >
            ...
            -->
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Usuario <i class="fas fa-user-circle fa-fw"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item disabled" href="<?= site_url('profile');?>"><?= _l('Profile');?></a>
                        <a class="dropdown-item disabled" href="<?= site_url('profile/logOut');?>"><?= _l('Logout');?></a>
                    </div>
                </li>
            </ul>
        </nav>
        ...
        <div id="wrapper">
            <?php $this->load->view( 'demo-parts/section-menu' ); ?>
